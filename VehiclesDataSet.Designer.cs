...
namespace VehicleDealership {
    ...
    public partial class VehiclesDataSet : global::System.Data.DataSet {
        ...
        public partial class MakeDataTable : global::System.Data.TypedTableBase<MakeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public MakeRow AddMakeRow(int makeID, string name) {
...
namespace VehicleDealership.VehiclesDataSetTableAdapters {
    ...
    public partial class MakeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Make] ([makeID], [name]) VALUES (@makeID, @name);\r\nSELECT make" +
                "ID, name FROM Make WHERE (makeID = @makeID)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Make] SET [makeID] = @makeID, [name] = @name WHERE (([makeID] = @Or" +
                "iginal_makeID) AND ([name] = @Original_name));\r\nSELECT makeID, name FROM Make WH" +
                "ERE (makeID = @makeID)";
        ...
        public virtual int Fill(VehiclesDataSet.MakeDataTable dataTable) {
        ...
        public virtual VehiclesDataSet.MakeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            VehiclesDataSet.MakeDataTable dataTable = new VehiclesDataSet.MakeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(VehiclesDataSet.MakeDataTable dataTable) {
        ...
        public virtual int Insert(int makeID, string name) {
        ...
        public virtual int Update(int makeID, string name, int Original_makeID, string Original_name) {
        ...
        public virtual int Update(string name, int Original_makeID, string Original_name) {
            return this.Update(Original_makeID, name, Original_makeID, Original_name);
        }
    }
